...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator kr3.spectator.op.gg:80 JF19/cFHhn600/6sAWvH9KNG+HlNBkWS 3798605565 KR-%RANDOM%%RANDOM%" "-UseRads" "-Locale=!locale!"
		goto :eof
	)
)
