...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator kr3.spectator.op.gg:80 qJY6JEOQNTZWPBaM/35NitLijxikbXLx 3798570680 KR-%RANDOM%%RANDOM%" "-UseRads" "-Locale=!locale!"
		goto :eof
	)
)
